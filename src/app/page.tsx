...
export default function Home() {
  ...
  const checkImageRender = async () => {
    try {
      const aw = await fetch("/controller-1.png");
      setIsLoaded(true);
      return aw;
    } catch (error) {
      setIsLoaded(false);
          ...
          <div className="h-[calc(100vh-13rem)] flex mt-4 justify-between">
            ...
            <div className="flex w-[80%] ">
              ...
              <motion.div className="w-1/2 flex flex-col gap-10">
                ...
                >
                  Refresh you set up this spring whith this contrasting green
                  and white wireless controller. play in style with new alpine
                  green edition of DUALSHOCK34 wireless controller.
                </motion.p>
              </motion.div>
